    ...
    <Container>
      ...
      >
        ...
        <div className="mt-24 container space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8">
          <div className="relative p-8  border border-gray-200/10 rounded-2xl shadow-sm flex flex-col bg-white/10 ">
          ...
          <div className="relative p-8  border border-[#e879f9] rounded-2xl shadow-sm flex flex-col backdrop-blur-2xl ">
            <div className="flex-1">
